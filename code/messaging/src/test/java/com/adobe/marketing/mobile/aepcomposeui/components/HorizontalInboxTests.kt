...
class HorizontalInboxTests(
    ...
    @Test
    fun `Test HorizontalInbox with mixed items`() {
        // setup
        ...
        composeTestRule.onRoot()
            .captureRoboImage(filePath = "build/outputs/roborazzi/HorizontalInboxTests_MixedItems_${Build.VERSION.SDK_INT}_$qualifier.png")
    }

    @Test
    fun `Test HorizontalInbox with mixed items in dark theme`() {
        // setup
        ...
        // Capture screenshot
        composeTestRule.onRoot()
            .captureRoboImage(filePath = "build/outputs/roborazzi/HorizontalInboxTests_MixedItemsDarkTheme_${Build.VERSION.SDK_INT}_$qualifier.png")
    }
    ...
    fun `Test HorizontalInbox respects capacity limit`() {
        ...
        // Capture screenshot
        composeTestRule.onRoot()
            .captureRoboImage(filePath = "build/outputs/roborazzi/HorizontalInboxTests_CapacityLimit_${Build.VERSION.SDK_INT}_$qualifier.png")
    }
    ...
    @Test
    fun `Test HorizontalInbox with custom styles`() {
        // setup
        setupImageMocking(mockLightBitmap)
        ...
        // Capture screenshot
        composeTestRule.onRoot()
            .captureRoboImage(filePath = "build/outputs/roborazzi/HorizontalInboxTests_CustomStyles_${Build.VERSION.SDK_INT}_$qualifier.png")
    }

    @Test
    fun `Test HorizontalInbox with custom styles in dark theme`() {
        // setup
        setupImageMocking(mockDarkBitmap)
        ...
        // Capture screenshot
        composeTestRule.onRoot()
            .captureRoboImage(filePath = "build/outputs/roborazzi/HorizontalInboxTests_CustomStylesDarkTheme_${Build.VERSION.SDK_INT}_$qualifier.png")
    }
}
