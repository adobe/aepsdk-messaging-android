...
class MessagingEventHandlerTests {
    ...
    @Test
    fun `Messaging event handler receives a display event`() {
        val callback = mock(ContentCardUIEventListening::class.java)
        val handler = MessagingEventHandler(callback)
    ...
    @Test
    fun `Messaging event handler receives a dismiss event`() {
        val callback = mock(ContentCardUIEventListening::class.java)
        val handler = MessagingEventHandler(callback)
    ...
    @Test
    fun `Messaging event handler receives a display event with no callback provided`() {
        val handler = MessagingEventHandler(null)
        val event = UIEvent.Display(mockAepUI)
    ...
    @Test
    fun `Messaging event handler receives a dismiss event with no callback provided`() {
        val handler = MessagingEventHandler(null)
        val event = UIEvent.Dismiss(mockAepUI)
