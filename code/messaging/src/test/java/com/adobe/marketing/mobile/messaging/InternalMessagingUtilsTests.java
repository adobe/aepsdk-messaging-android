...
public class InternalMessagingUtilsTests {
    ...
    // =====================================================================
    // isUsePersistedContentCards
    // =====================================================================

    @Test
    public void testIsUsePersistedContentCards_returnTrue_validEvent() {
        final Map<String, Object> data = new HashMap<>();
    ...
    @Test
    public void testIsUsePersistedContentCards_returnFalse_nullEvent() {
        assertFalse(InternalMessagingUtils.isUsePersistedContentCards(null));
    }

    @Test
    public void testIsUsePersistedContentCards_returnFalse_nullEventData() {
        final Event event =
                new Event.Builder(
                                "Get persisted content cards",
                                EventType.MESSAGING,
    ...
    @Test
    public void testIsUsePersistedContentCards_returnFalse_flagIsFalse() {
        final Map<String, Object> data = new HashMap<>();
        data.put(MessagingTestConstants.EventDataKeys.Messaging.USE_PERSISTED_CONTENT_CARDS, false);
        final Event event =
                new Event.Builder(
                                "Get persisted content cards",
                                EventType.MESSAGING,
    ...
    @Test
    public void testIsUsePersistedContentCards_returnFalse_keyMissing() {
        final Event event =
                new Event.Builder(
                                "Get persisted content cards",
                                EventType.MESSAGING,
