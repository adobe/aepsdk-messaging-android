...
data class AepImage(
    ...
    constructor(imageMap: Map<String, Any>) : this(
        url = imageMap[AepTemplateConstants.CardTemplate.UIElement.Image.URL] as? String,
        darkUrl = imageMap[AepTemplateConstants.CardTemplate.UIElement.Image.DARK_URL] as? String,
        bundle = imageMap[AepTemplateConstants.CardTemplate.UIElement.Image.BUNDLE] as? String,
        darkBundle = imageMap[AepTemplateConstants.CardTemplate.UIElement.Image.DARK_BUNDLE] as? String,
        icon = imageMap[AepTemplateConstants.CardTemplate.UIElement.Image.ICON] as? String,
        iconSize = (imageMap[AepTemplateConstants.CardTemplate.UIElement.Image.ICON_SIZE] as? Number)?.toInt()
    )
}
