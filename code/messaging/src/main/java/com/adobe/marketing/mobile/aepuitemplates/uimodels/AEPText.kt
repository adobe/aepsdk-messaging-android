...
data class AepText(
    ...
    constructor(textSchemaMap: Map<String, Any>) : this(
        content = textSchemaMap[AepTemplateConstants.CardTemplate.UIElement.Text.CONTENT] as? String,
        clr = textSchemaMap[AepTemplateConstants.CardTemplate.UIElement.Text.CLR] as? String,
        align = textSchemaMap[AepTemplateConstants.CardTemplate.UIElement.Text.ALIGN] as? String,
        font = (textSchemaMap[AepTemplateConstants.CardTemplate.UIElement.Text.FONT] as? Map<String, Any>)?.let {
            AepFont(it)
        }
    )
}
