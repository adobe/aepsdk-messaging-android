...
data class AepFont(
    ...
    constructor(fontMap: Map<String, Any>) : this(
        name = fontMap[AepTemplateConstants.CardTemplate.UIElement.Font.NAME] as? String,
        size = (fontMap[AepTemplateConstants.CardTemplate.UIElement.Font.SIZE] as? Number)?.toInt(),
        weight = fontMap[AepTemplateConstants.CardTemplate.UIElement.Font.WEIGHT] as? String,
        style = (fontMap[AepTemplateConstants.CardTemplate.UIElement.Font.STYLE] as? List<*>)?.filterIsInstance<String>()
    )
}
