...
public class Surface implements Serializable {
    ...
    private Surface(final boolean isFullPathString, final String path) {
        if (!isFullPathString) {
            ...
            this.uri = StringUtils.isNullOrEmpty(packageName) ? UNKNOWN_SURFACE :
                    StringUtils.isNullOrEmpty(path) ? SURFACE_BASE + packageName : SURFACE_BASE + packageName + File.separator + path;
        } else {
