...
final class MessagingConstants {
    ...
    final class EventDataKeys {
        ...
        final class RulesEngine {
            ...
            static final String MESSAGE_CONSEQUENCE_INBOUND_TYPE_VALUE = "ajoInbound";
            static final String MESSAGE_CONSEQUENCE_IAM_TYPE_VALUE = "ajoIam";
            static final String MESSAGE_CONSEQUENCE_ALERT_TYPE_VALUE = "ajoAlert";
            static final String MESSAGE_CONSEQUENCE_FEED_ITEM_TYPE_VALUE = "ajoFeedItem";
