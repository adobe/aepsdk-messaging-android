...
2. Get the Messaging test app from the GitHub repository - https://github.com/adobe/aepsdk-messaging-android by following one of the below options.
    - Option 1: Clone the code from https://github.com/adobe/aepsdk-messaging-android.git. Checkout `exd-cbe-beta` branch.
...
6. In the testapp, press the `Check Code Based Experiences` button from the main app screen. You should see the Code-based experiences for your configured surface (mobileapp://com.adobe.marketing.mobile.messagingsample/<your-surface-path>).